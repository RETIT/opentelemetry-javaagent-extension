...
| IO_RETIT_EMISSIONS_ONPREMISE_INSTANCE_VCPU_COUNT | double                                                             | 0.0     | Number of instance vCPUs (only used when cloud provider is OnPremise).                                                               |
| IO_RETIT_EMISSIONS_ONPREMISE_PLATFORM_TOTAL_VCPU_COUNT | double                                                             | 0.0     | Total number of platform vCPUs (only used when cloud provider is OnPremise).                                                         |
| IO_RETIT_EMISSIONS_ONPREMISE_CPU_POWER_IDLE | double                                                             | 0.0     | CPU power consumption in Watts at idle (only used when cloud provider is OnPremise).                                                 |
| IO_RETIT_EMISSIONS_ONPREMISE_CPU_POWER_100 | double                                                             | 0.0     | CPU power consumption in Watts at 100% utilization (only used when cloud provider is OnPremise).                                     |
| IO_RETIT_EMISSIONS_ONPREMISE_TOTAL_EMBODIED_EMISSIONS | double                                                             | 0.0     | Total embodied emissions in kg CO2e (only used when cloud provider is OnPremise).                                                    |
| IO_RETIT_EMISSIONS_ONPREMISE_GRID_EMISSIONS_FACTOR | double                                                             | 0.0     | Grid emissions factor in kg CO2e per kWh (only used when cloud provider is OnPremise).                                               |
| IO_RETIT_EMISSIONS_ONPREMISE_PUE | double                                                             | 0.0     | Power Usage Effectiveness (PUE) value of the datacenter (only used when cloud provider is OnPremise).                                |
